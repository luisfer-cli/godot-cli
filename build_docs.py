...
<body>
  <header class='topbar'><button id='menuButton' aria-label='Toggle navigation'>☰</button><a class='topbrand' href='index.html'>godot-cli docs</a><a href='https://github.com/luisfer-cli/godot-cli'>GitHub</a></header>
  <aside class='sidebar' id='sidebar'>
    <a class='brand' href='index.html'>godot-cli</a>
